...
params_est = DPMParams(0.9269,1.1029,0.0113,0.00693,0.2256,0.1965,0.1138,0.2073,-0.1632,-0.1121,
                       -0.00185,0.00031,0.7698,0.4534)
# params for new DIDP model fitted using full 2D model w/ 10 quantiles: chisq = 3224

# params_est = DPMParams(0.6951,1.1565,0.0125,0.00706,0.2684,0.1840,0.1153,0.2044,-0.1557,-0.1666,
#                        -0.00182,0.00026,0.6786,0.5559)
# # params for new DIDP model fitted using separable 1D approximation w/ 10 quantiles: chisq = 4012
